...
public class ProvinceController  implements Serializable {
    ...
    private DataModel<Province> items = null;
    ...
    public DataModel<Province> getItems() {
    ...
    public ProvinceFacade getEjbFacade() {
        return ejbFacade;
    }

    public void setEjbFacade(ProvinceFacade ejbFacade) {
