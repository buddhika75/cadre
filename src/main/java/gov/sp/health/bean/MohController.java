...
public class MohController  implements Serializable {
    ...
    List<MohArea> lstItems;
    private MohArea current;
    private DataModel<MohArea> items = null;
    DataModel<DpdhsArea> dpdhsAreas;
    List<DpdhsArea> lstDpdhsAreas;
    ...
    public List<DpdhsArea> getLstDpdhsAreas() {
        return getDpdhsFacade().findBySQL("SELECT d FROM DpdhsArea d WHERE d.retired=false ORDER BY d.name");
    }

    public void setLstDpdhsAreas(List<DpdhsArea> lstDpdhsAreas) {
        this.lstDpdhsAreas = lstDpdhsAreas;
    }
    ...
    public List<MohArea> getLstItems() {
        return getFacade().findBySQL("Select d From MohArea d WHERE d.retired=false ORDER BY d.name");
    }

    public void setLstItems(List<MohArea> lstItems) {
    ...
    private MohFacade getFacade() {
        return ejbFacade;
    }

    public DataModel<MohArea> getItems() {
    ...
    public MohFacade getEjbFacade() {
        return ejbFacade;
    }

    public void setEjbFacade(MohFacade ejbFacade) {
    ...
    public static class MohControllerConverter implements Converter {
